...
jq '[.[] | select(.pk == 703 or .pk == 157)]' ../fixtures.all/fastlap.json > fastlap.json
jq '[.[] | select(.fields.fast_lap == 703 or .fields.fast_lap == 157)]' ../fixtures.all/fastlapsegment.json > fastlapsegment.json
jq '[.[] | select(.fields.fast_lap == 703 or .fields.fast_lap == 157)]' ../fixtures.all/lap.json > lap.json
